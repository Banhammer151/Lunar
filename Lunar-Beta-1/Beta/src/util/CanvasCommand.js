...
class CanvasCommands {
  static async loadResources() {
    ...
    try {
      firstWord = fs.readFileSync("./src/data/firstword.jpg", function(e) {});
      nnsei = fs.readFileSync("./src/data/nnsei.jpg", function(e) {});
      laranjo = fs.readFileSync("./src/data/laranjo.jpg", function(e) {});
      respect = fs.readFileSync("./src/data/respect.jpg", function(e) {});
      prvideo = fs.readFileSync("./src/data/pr.jpg", function(e) {});
      falso = fs.readFileSync("./src/data/block.jpg", function(e) {});
      treta = fs.readFileSync("./src/data/treta.jpg", function(e) {});
      ...
      google = fs.readFileSync("./src/data/google.jpg", function(e) {});
      xvideos = fs.readFileSync("./src/data/xvideos.jpg", function(e) {});
