...
class DailyCommand extends Command {
  ...
  async run(msg) {
    ...
    var z = 1;
    if (!roles.shop[0]) return msg.channel.send("Sorry, this guild don't use my shop system... To add a role, use `@Lunar addshoprole Price RoleName`");
    var arr = [];
    ...
    var embed = new Discord.RichEmbed()
      ...
      .setColor(0xFF00F0)
      .setFooter("If you want buy a role, use @Lunar buyrole RoleName")
      .setAuthor("And to add a role to shop, use @Lunar addshoprole Price RoleName");
